    ...
    <div v-if="!isSubmitting" class="pt-16 px-6 pb-6">
      ...
      <div class="flex mt-6">
        <label class="flex">
          ...
          <!-- eslint-disable-next-line -->
          <p class="ml-2 text-gray-900">By Registering, you agree to the <a href="https://app.termly.io/document/terms-of-use-for-online-marketplace/d267420e-06d2-425c-ab67-02ad2d30d650" class="underline text-royal-blue" target="_blank">Terms of Service</a> and <a href="https://app.termly.io/document/privacy-notice/8f2f9ffe-77dc-431f-8466-2de5037b4740" class="underline text-royal-blue"  target="_blank">Privacy Policy</a>.</p>
        </label>
      </div>
    </div>
